...
// Sending the data as float: Set up the pin
SoftwareSerial rotationSerial(3, 2); // TX, RX
...
void setup() {
  ...
  rotationSerial.begin(9600); //Sending the Data: Pin
...
void loop() 
{
  ...
  while (1) 
  {
    ...
    { 
      ...
      // Sending the Data
      rotationSerial.println(count); // Send count
      Serial.print("Sent: ");
      Serial.println(count);
      count = 0; // Reset for next direction
